...
Initial release for Fabric 1.20.1.

- Identical items stack without limit inside chests, barrels, shulker boxes, ender chests and modded lootable containers (Iron Chests, Supplementaries sacks and safes, ...).
- Items taken out stack normally again (64 / 16 / 1).
